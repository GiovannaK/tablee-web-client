import { Box, Divider, Grid, ListItem, ListItemIcon } from '@mui/material';
      ...
      <Grid container mt={2} spacing={1.4}>
        <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
          <ListItem>
            ...
            <Paragraph>Avenida xxxx, 6789, São Paulo, SP.</Paragraph>
          </ListItem>
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
          <ListItem>
            ...
            <Paragraph>Estacionamento Disponível</Paragraph>
          </ListItem>
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
          <ListItem>
